...
class wpl_html
{
	...
	public static function generate_canonical()
	{
        ...
        {
			wpl_esc::e(PHP_EOL);
			wpl_esc::e('<link rel="canonical" href="'.wpl_esc::return_url(self::$canonical).'" />');
            return;
        }
		...
		wpl_esc::e(PHP_EOL);
		wpl_esc::e('<link rel="canonical" href="'.wpl_esc::return_url($link).'" />');
	}
	...
	public static function generate_head()
	{
		...
		{
			wpl_esc::e('<meta name="keywords" content="'. wpl_esc::return_attr(implode(',', self::$meta_keywords)).'" />');
		}
		
		/** generate meta description **/
		if(self::$meta_description)
		{
			wpl_esc::e('<meta name="description" content="'. wpl_esc::return_attr(self::$meta_description) .'" />');
		}
	...
	{
        /** PRO Add-on **/
        if(!wpl_global::check_addon('PRO')) return wpl_esc::return_html_t('The PRO Add-on must be installed for this feature.');
    ...
    public function load_market_reports($instance = array())
    {
        /** Market Reports Add-on **/
        if(!wpl_global::check_addon('market_reports')) return wpl_esc::return_html_t('The Market Reports Add-on must be installed for this feature.');

        return wpl_html::load_view('b:addon_market_reports:home', $instance);
    }

    public function load_mortgage_calculator($instance = array())
    {
        /** Market Reports Add-on **/
        if(!wpl_global::check_addon('mortgage_calculator')) return wpl_esc::return_html_t('The Mortgage Calculator Add-on must be installed for this feature.');

        // Force Activity to Show
        if(!is_array($instance)) $instance = array();
        $instance['force'] = 1;

        ob_start();
        wpl_global::import_activity('mortgage_calculator:default', '', $instance);
