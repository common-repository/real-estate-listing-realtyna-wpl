	...
	<div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
			...
			<div class="fanc-row">
				...
				<input type="text" name="<?php wpl_esc::attr($__prefix); ?>opt_ext_file" id="<?php wpl_esc::attr($__prefix); ?>opt_ext_file" placeholder="jpg,gif,png" value="<?php wpl_esc::attr(isset($options['ext_file']) ? $options['ext_file'] : ''); ?>" />
			</div>
			<div class="fanc-row">
