...
<div class="fanc-body">
	<div class="fanc-row fanc-button-row-2">
        ...
        <?php if($dbst_id and $dbst_id >= 3000): ?><input class="wpl-button button-2" type="button" onclick="convert_dbst('<?php wpl_esc::attr($__prefix); ?>', <?php wpl_esc::attr($dbst_id); ?>, 'select');" value="<?php wpl_esc::attr_t('Convert to Select'); ?>" id="wpl_dbst_convert_button" /><?php endif; ?>
