		...
		<div class="col-wp">
			...
			<div class="col-fanc-right" id="wpl_flex_specific_options">
				...
				<div class="fanc-row">
					...
					<input type="text" name="<?php wpl_esc::attr($__prefix); ?>opt_ext_file"
						   id="<?php wpl_esc::attr($__prefix); ?>opt_ext_file"
						   value="<?php wpl_esc::attr($options['ext_file'] ?? ''); ?>"/>
				</div>
				<div class="fanc-row">
					<label for="<?php wpl_esc::attr($__prefix); ?>opt_file_size"><?php wpl_esc::html_t('Maximum file size'); ?></label>
					<input type="text" name="<?php wpl_esc::attr($__prefix); ?>opt_file_size"
						   id="<?php wpl_esc::attr($__prefix); ?>opt_file_size"
						   value="<?php wpl_esc::attr($options['file_size'] ?? ''); ?>"/>
				</div>
			</div>
		</div>
	</div>
