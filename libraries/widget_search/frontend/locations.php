...
if($type == 'locations' and !$done_this)
{
    ...
    /** Place-holder **/
	$placeholder = ( trim( $field['extoption'] ?? '' ) ) ? $field['extoption'] : $location_settings['locationzips_keyword'].', '.$location_settings['location3_keyword'].', '.$location_settings['location1_keyword'];
	...
	foreach($location_files as $location_file) include($location_path .DS. $location_file);
}