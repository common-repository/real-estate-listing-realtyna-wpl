...
if ($type == 'gallery' and !$done_this) {
	...
	if ($show == 'datepicker') {
		...
		$html .= '<div class="wpl_search_widget_from_container"><label class="wpl_search_widget_from_label" for="sf' . $widget_id . '_datemin_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Min') . '</label><input type="text" placeholder="' . sprintf(wpl_esc::return_attr_t('Min %s'), wpl_esc::return_attr_t($field['name'])) . '" name="sf' . $widget_id . '_datemin_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_datemin_' . $field_data['table_column'] . '" value="' . ($current_min_value != '' ? esc_attr($current_min_value) : '') . '" /></div>';
		$html .= '<div class="wpl_search_widget_to_container"><label class="wpl_search_widget_to_label" for="sf' . $widget_id . '_datemax_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Max') . '</label><input type="text" placeholder="' . sprintf(wpl_esc::return_attr_t('Max %s'), wpl_esc::return_attr_t($field['name'])) . '" name="sf' . $widget_id . '_datemax_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_datemax_' . $field_data['table_column'] . '" value="' . ($current_max_value != '' ? esc_attr($current_max_value) : '') . '" /></div>';
	...
	if ($show == 'checkbox') {
		$html .= '<input value="1" ' . ($current_value == 1 ? 'checked="checked"' : '') . ' name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" type="checkbox" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '_check" onchange="wpl_field_specific_changed' . $widget_id . '(\'' . $field['id'] . '\')" data-specific="' . $specified_children . '"/>
        	<label for="sf' . $widget_id . '_select_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>';
	} elseif ($show == 'yesno') {
		...
		$html .= '<label for="sf' . $widget_id . '_select_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>
			<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '_select" onchange="wpl_field_specific_changed' . $widget_id . '(\'' . $field['id'] . '\')" data-specific="' . $specified_children . '">
				<option value="-1" ' . ($current_value == -1 ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>
				<option value="1" ' . ($current_value == 1 ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t('Yes') . '</option>
				<option value="0" ' . ($current_value == 0 ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t('No') . '</option>
			</select>';
	} elseif ($show == 'options') {
		/** current value **/
		...
		$html .= '<label for="sf' . $widget_id . '_feature_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>
			<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_feature_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_feature_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '_select" ' . ($multiple ? 'multiple="multiple"' : '') . '>';

		if (!$multiple) $html .= '<option value="">' . wpl_esc::return_html_t($field['name']) . '</option>';
		foreach ($options['values'] as $option) {
			if (isset($option['enabled']) and !$option['enabled']) continue;

			$html .= '<option value="' . esc_attr($option['key']) . '" ' . (in_array($option['key'], $current_value) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value']) . '</option>';
		}
	...
	if ($label) $html .= '<label for="sf' . $widget_id . '_select_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>';

	if ($show == 'select') {
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" onchange="wpl_listing_changed' . $widget_id . '(this.value);">';
		if ($any) $html .= '<option value="-1" selected="selected">' . wpl_esc::return_html_t($field['name']) . '</option>';
		...
		foreach ($listings as $listing) {
			...
			$html .= '<option value="' . esc_attr($listing['id']) . '" ' . ($current_value == $listing['id'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($listing['name']) . '</option>';
		}
		...
		<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '"  data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" class="wpl_searchmod_' . $field_data['table_column'] . '_multiselect" id="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" multiple="multiple">';

		foreach ($listings as $listing) {
			// Skip if listing type is not allowed for this user
			if (is_array($availables) and count($availables) and !in_array($listing['id'], $availables)) continue;

			$html .= '<option value="' . esc_attr($listing['id']) . '" ' . (in_array($listing['id'], $current_values) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($listing['name']) . '</option>';
		}
		...
		$html .= '<input value="' . esc_attr($render_current_value) . '" type="hidden" id="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" />';
	} elseif ($show == 'radios') {
		$i = 0;
		...
		$html .= '<input value="' . esc_attr($current_value) . '" type="hidden" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" onchange="wpl_listing_changed' . $widget_id . '(this.value);" />';
		...
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" onchange="wpl_listing_changed' . $widget_id . '(this.value);">';
		if ($any) $html .= '<option value="-1">' . wpl_esc::return_html_t($field['name']) . '</option>';

		foreach ($listings as $listing) {
			// Skip if listing type is not allowed for this user
			if (is_array($availables) and count($availables) and !in_array($listing['id'], $availables)) continue;

			if (is_array($field['extoption']) and in_array($listing['id'], $field['extoption'])) $html .= '<option value="' . esc_attr($listing['id']) . '" ' . ($current_value == $listing['id'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($listing['name']) . '</option>';
		}
	...
	if ($show == 'text') {
		...
		$html .= '<input name="sf' . $widget_id . '_text_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_text_' . $field_data['table_column'] . '" value="' . esc_attr($current_value) . '" placeholder="' . wpl_esc::return_attr_t($field['name']) . '" />';
	} elseif ($show == 'exacttext') {
		/** current values **/
		$current_value = stripslashes(wpl_request::getVar('sf_select_' . $field_data['table_column'], ''));

		$html .= '<input name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" value="' . esc_attr($current_value) . '"  placeholder="' . wpl_esc::return_attr_t($field['name']) . '"/>';
	} elseif ($show == 'minmax') {
		$html .= '<label class="wpl_search_widget_from_label" for="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Min') . '</label>';
		$html .= '<input name="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '" value="' . (trim(wpl_request::getVar('sf_tmin_' . $field_data['table_column'], '')) != '' ? esc_attr($current_min_value) : (isset($extoptions[0]) ? $extoptions[0] : '')) . '" placeholder="' . wpl_esc::return_attr_t('Min') . '" />';

		$html .= '<label class="wpl_search_widget_to_label" for="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Max') . '</label>';
		$html .= '<input name="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '" value="' . (trim(wpl_request::getVar('sf_tmax_' . $field_data['table_column'], '')) != '' ? esc_attr($current_max_value) : (isset($extoptions[1]) ? $extoptions[1] : '')) . '" placeholder="' . wpl_esc::return_attr_t('Max') . '" />';
		...
		$html .= '<span class="wpl_search_slider_container">
				<input type="hidden" value="' . esc_attr($current_min_value) . '" name="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '" /><input type="hidden" value="' . $current_max_value . '" name="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '" />
		...
		$i = $min_value;
		$html .= '<option value="0" ' . ($current_min_value == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Min %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
		...
		$i = $min_value;
		$html .= '<option value="999999999999" ' . ($current_max_value == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Max %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
		...
		$html .= '<select name="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_tmin_' . $field_data['table_column'] . '">';
		$html .= '<option value="-1" ' . ($current_min_value == $i ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>';
		...
		$html .= '<select name="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_tmax_' . $field_data['table_column'] . '">';
		$html .= '<option value="-1" ' . ($current_max_value == $i ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>';
	...
	if ($show == 'text') {
		/** current values **/
		$current_value = stripslashes(wpl_request::getVar('sf_mmnumber_' . $field_data['table_column'], ''));

		$html .= '<input name="sf' . $widget_id . '_mmnumber_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_mmnumber_' . $field_data['table_column'] . '" value="' . $current_value . '" placeholder="' . wpl_esc::return_attr_t($field['name']) . '" />';
		...
		$html .= '<option value="-1" ' . ($current_value == $i ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>';
	...
	if ($label) $html .= '<label>' . wpl_esc::return_html_t($field['name']) . '</label>';

	if ($show == 'select') {
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field_data['table_column'] . ' wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" onchange="wpl_property_type_changed' . $widget_id . '(this.value);">';
		if ($any) $html .= '<option value="-1">' . wpl_esc::return_html_t($field['name']) . '</option>';
		...
		foreach ($property_types as $property_type) {
			...
			$html .= '<option class="wpl_pt_parent wpl_pt_parent' . $property_type['parent'] . '" value="' . $property_type['id'] . '" ' . ($current_value == $property_type['id'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($property_type['name']) . '</option>';
		}
		...
		$html .= '<div class="wpl_searchwid_' . $field_data['table_column'] . '_multiselect_container">
		<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" class="wpl_search_widget_field_' . $field_data['table_column'] . ' wpl_searchmod_' . $field_data['table_column'] . '_multiselect" id="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" multiple="multiple">';

		foreach ($property_types as $property_type) {
			// Skip if property type is not allowed for this user
			if (is_array($availables) and count($availables) and !in_array($property_type['id'], $availables)) continue;

			$html .= '<option class="wpl_pt_parent wpl_pt_parent' . $property_type['parent'] . '" value="' . $property_type['id'] . '" ' . (in_array($property_type['id'], $current_values) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($property_type['name']) . '</option>';
		}
		...
		foreach ($property_types as $property_type) {
			...
			if (!empty($field['extoption']) and is_array($field['extoption']) and in_array($property_type['id'], $field['extoption'])) $html .= '<option class="wpl_pt_parent wpl_pt_parent' . $property_type['parent'] . '" value="' . $property_type['id'] . '" ' . ($current_value == $property_type['id'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($property_type['name']) . '</option>';
		}
	...
	if ($show == 'select') {
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_' . $type . '_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_' . $type . '_' . $field_data['table_column'] . '">';
		if ($any) $html .= '<option value="-1">' . wpl_esc::return_html_t($field['name']) . '</option>';

		foreach ($options['params'] as $option) {
			if (!$option['enabled']) continue;

			$html .= '<option value="' . $option['key'] . '" ' . ($current_value == $option['key'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value'] ?? 'Error') . '</option>';
		}
		...
		$html .= '<div class="wpl_searchwid_' . $field_data['table_column'] . '_multiselect_container">
		<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" class="wpl_searchmod_' . $field_data['table_column'] . '_multiselect" id="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" multiple="multiple">';

		foreach ($options['params'] as $option) {
			if (!$option['enabled']) continue;

			$html .= '<option value="' . $option['key'] . '" ' . (in_array($option['key'], $current_values) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value'] ?? 'Error') . '</option>';
		}
		...
		if (is_array($field['extoption'])) $type = 'multiple';
		...
		foreach ($options['params'] as $option) {
			...
			if (is_array($field['extoption']) and in_array($option['key'], $field['extoption'])) $html .= '<option value="' . $option['key'] . '" ' . (in_array($option['key'], $current_values) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value'] ?? 'Error') . '</option>';
		}
	...
	if ($show == 'select') {
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_select_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '_select_' . $field_data['table_column'] . '">';
		if ($any) $html .= '<option value="">' . wpl_esc::return_html_t($field['name']) . '</option>';

		foreach ($options as $option) $html .= '<option value="' . $option['key'] . '" ' . ($current_value == $option['key'] ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value']) . '</option>';
		...
		$html .= '<div class="wpl_searchwid_' . $field_data['table_column'] . '_multiselect_container">
		<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" class="wpl_searchmod_' . $field_data['table_column'] . '_multiselect" id="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" name="sf' . $widget_id . '_multiple_' . $field_data['table_column'] . '" multiple="multiple">';

		foreach ($options as $option) $html .= '<option value="' . $option['key'] . '" ' . (in_array($option['key'], $current_values) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($option['value']) . '</option>';
	...
	$html .= '<label for="sf' . $widget_id . '_text_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>
				<textarea name="sf' . $widget_id . '_text_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_text_' . $field_data['table_column'] . '">' . esc_textarea($current_value) . '</textarea>';
	...
	if ($division != 1 && $field['type'] <> 'minmax') while (($max_value - $min_value) / $division > 5000) $division *= 10;
	...
	if ($division_rental != 1) while (($max_value_rental - $min_value_rental) / $division_rental > 5000) $division_rental *= 10;
	...
	if ($show == 'minmax') {
		...
		if ($input_type == 'number') $html .= '<label id="wpl_search_widget_from_label' . $widget_id . '" class="wpl_search_widget_from_label" for="sf' . $widget_id . '_min_' . $min_column . '">' . sprintf(wpl_esc::return_html_t('Min %s'), $field_data['name']) . '</label>';
		$html .= '<input name="sf' . $widget_id . '_min_' . $min_column . '" type="' . $input_type . '" id="sf' . $widget_id . '_min_' . $min_column . '" step="' . $division . '" min="' . $min_value . '" value="' . $current_min_value . '" placeholder="' . sprintf(wpl_esc::return_attr_t('Min %s'), wpl_esc::return_attr_t($field_data['name'])) . '" />';

		if ($input_type == 'number') $html .= '<label id="wpl_search_widget_to_label' . $widget_id . '" class="wpl_search_widget_to_label" for="sf' . $widget_id . '_max_' . $max_column . '">' . sprintf(wpl_esc::return_html_t('Max %s'), $field_data['name']) . '</label>';
		$html .= '<input name="sf' . $widget_id . '_max_' . $max_column . '" type="' . $input_type . '" id="sf' . $widget_id . '_max_' . $max_column . '" step="' . $division . '" min="' . $min_value . '" value="' . $current_max_value . '" placeholder="' . sprintf(wpl_esc::return_attr_t('Max %s'), wpl_esc::return_attr_t($field_data['name'])) . '" />';
	} elseif ($show == 'minmax_slider') {
		...
		foreach ($listing_fields as $list => $listing_field) {
			...
			if ($any) $html .= '<option value="0" ' . ($listing_field['cur_min'] == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Min %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
			...
			if ($any) $html .= '<option value="999999999999" ' . ($listing_field['cur_max'] == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Max %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
		...
		foreach ($listing_fields as $list => $listing_field) {
			...
			$html .= '<select name="sf' . $widget_id . '_min_' . $min_column . '" id="sf' . $widget_id . '_min_' . $min_column . '_' . $list . '" class="wpl_search_widget_price_field ' . ($list == $hide_listing ? 'wpl-exclude-search-widget' : '') . '" data-chosen-opt="width:100px">';
			$html .= '<option value="-1" ' . ($listing_field['cur_min'] == $i ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>';
		...
		foreach ($listing_fields as $list => $listing_field) {
			...
			$html .= '<select name="sf' . $widget_id . '_max_' . $max_column . '" id="sf' . $widget_id . '_max_' . $max_column . '_' . $list . '" class="wpl_search_widget_price_field ' . ($list == $hide_listing ? 'wpl-exclude-search-widget' : '') . '" data-chosen-opt="width:100px">';
			$html .= '<option value="-1" ' . ($listing_field['cur_max'] == $i ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($field['name']) . '</option>';
	...
	// Get Units
	$condition = '';
	if ($default_unit_id) $condition .= wpl_db::prepare(" AND `id` = %d", $default_unit_id);
	...
	if ($show == 'minmax') {
		if ($input_type == 'number') $html .= '<label id="wpl_search_widget_from_label' . $widget_id . '" class="wpl_search_widget_from_label" for="sf' . $widget_id . '_min_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Min') . '</label>';
		$html .= '<input name="sf' . $widget_id . '_min_' . $min_column . '" type="' . $input_type . '" id="sf' . $widget_id . '_min_' . $min_column . '" step="' . $division . '" min="' . $min_value . '" value="' . (trim(wpl_request::getVar('sf_min_' . $min_column, '')) != '' ? $current_min_value : (isset($extoptions[0]) ? $extoptions[0] : '')) . '" placeholder="' . wpl_esc::return_attr_t('Min') . '" />';

		if ($input_type == 'number') $html .= '<label id="wpl_search_widget_to_label' . $widget_id . '" class="wpl_search_widget_to_label" for="sf' . $widget_id . '_max_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t('Max') . '</label>';
		$html .= '<input name="sf' . $widget_id . '_max_' . $max_column . '" type="' . $input_type . '" id="sf' . $widget_id . '_max_' . $max_column . '" step="' . $division . '" min="' . $min_value . '" value="' . (trim(wpl_request::getVar('sf_max_' . $max_column, '')) != '' ? $current_max_value : (isset($extoptions[1]) ? $extoptions[1] : '')) . '" placeholder="' . wpl_esc::return_attr_t('Max') . '" />';
	} elseif ($show == 'minmax_slider') {
		wpl_html::set_footer('<script type="text/javascript">
		...
		if ($any) $html .= '<option value="0" ' . ($current_min_value == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Min %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
		...
		if ($any) $html .= '<option value="999999999999" ' . ($current_max_value == $i ? 'selected="selected"' : '') . '>' . sprintf(wpl_esc::return_html_t('Max %s'), wpl_esc::return_html_t($field_data['name'])) . '</option>';
	...
	if ($field['type'] == 'checkbox') {
		$html .= '<input value="1" ' . ($current_value == 1 ? 'checked="checked"' : '') . ' name="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" type="checkbox" id="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" class="wpl_search_widget_field_' . $field['id'] . '_check" />
        	<label for="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>';
		...
		$html .= '<label for="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>
				<input name="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_' . $query_type . '_' . $field_data['table_column'] . '" value="' . esc_attr($current_value) . '" placeholder="' . wpl_esc::return_attr_t($field['name']) . '" />';
	}
	...
	$html .= '<label for="sf' . $widget_id . '_textsearch_' . $field_data['table_column'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>';

	if ($show == 'text') {
		$html .= '<input value="' . esc_attr($current_value) . '" name="sf' . $widget_id . '_textsearch_' . $field_data['table_column'] . '" type="text" id="sf' . $widget_id . '_textsearch_' . $field_data['table_column'] . '" placeholder="' . wpl_esc::return_attr_t($field['name']) . '" />';
	} elseif ($show == 'textarea') {
		$html .= '<textarea name="sf' . $widget_id . '_textsearch_' . $field_data['table_column'] . '" id="sf' . $widget_id . '_textsearch_' . $field_data['table_column'] . '">' . esc_textarea($current_value) . '</textarea>';
	}
	...
	$html .= '<label>' . wpl_esc::return_html_t($field['name']) . '</label>';
	$html .= '<input type="text" name="sf' . $widget_id . '_calendarcheckin" id="sf' . $widget_id . '_calendarcheckin" value="' . ($current_checkin_value != '' ? $current_checkin_value : '') . '" placeholder="' . wpl_esc::return_attr_t('Check In') . '" />';
	$html .= '<input type="text" name="sf' . $widget_id . '_calendarcheckout" id="sf' . $widget_id . '_calendarcheckout" value="' . ($current_checkout_value != '' ? $current_checkout_value : '') . '" placeholder="' . wpl_esc::return_attr_t('Check Out') . '" />';
	$html .= '</div>';
	...
	if ($show == 'select') {
		$html .= '<select data-placeholder="' . wpl_esc::return_attr_t($field['name']) . '" name="sf' . $widget_id . '_ptcategory" class="wpl_search_widget_field_' . $field['id'] . '" id="sf' . $widget_id . '__ptcategory">';
		if ($any) $html .= '<option value="-1">' . wpl_esc::return_html_t($field['name']) . '</option>';

		foreach ($categories as $category)
			$html .= '<option data-id="' . $category['id'] . '" value="' . $category['name'] . '" ' . (strtolower($current_value) == strtolower($category['name']) ? 'selected="selected"' : '') . '>' . wpl_esc::return_html_t($category['name']) . '</option>';
	...
	$html .= '<label id="wpl' . $widget_id . '_search_widget_separator_' . $field['id'] . '">' . wpl_esc::return_html_t($field['name']) . '</label>';
