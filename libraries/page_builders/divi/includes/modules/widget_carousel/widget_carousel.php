...
class wpl_page_builders_divi_widget_carousel extends ET_Builder_Module
{
    ...
    {
        $this->name =wpl_esc::return_t('WPL Carousel Widget');
    ...
    public function get_fields()
    {
        ...
        $fields['id'] = array(
            ...
            'description'     => wpl_esc::return_html_t('Select your desired carousel widget to show. if there is no widget in the list, Please configure some in Appearance->Widgets menu. You can put them inside of WPL Hidden sidebar.'),
        );
