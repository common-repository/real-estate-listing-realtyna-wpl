    ...
    public function build()
    {
        ...
        $this->built = array('property_show_sections'=>array(
            ...
            array(
                ...
                'title'=>'FACTS',
                'content'=>array(
                   wpl_esc::return_t('Lot Area').': '.$result['lot_area'].' '.$area_unit,
                   wpl_esc::return_t('Price').': '.wpl_render::render_price($result['price'], $result['price_unit']),
                   wpl_esc::return_t('Listing ID').': '.$result['mls_id'],
                )
            ),
            array(
