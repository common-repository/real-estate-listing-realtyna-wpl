...
class wpl_io_cmd_get_template extends wpl_io_cmd_base
{
    ...
    public function zip_icons($destination)
    {
        ...
        if($this->params['os'] == "android")
        {
            ...
            wpl_folder::copy(wpl_global::get_upload_base_path() . 'addon_mobile_application' . DS . $this->params['os'] . DS . 'drawable', $folder_path . DS . 'drawable', '', true);
            wpl_folder::copy(wpl_global::get_upload_base_path() . 'addon_mobile_application' . DS . $this->params['os'] . DS . 'drawable-' . $this->params['screen_size'], $folder_path . DS . 'drawable-' . $this->params['screen_size'], '', true);
    ...
    protected function get_icons($density)
    {
        if($this->os == 'android')
        {
            $zip_path = wpl_global::get_upload_base_path() . 'addon_mobile_application' . DS . $this->os . DS . 'zip' . DS . $density . '.zip';
