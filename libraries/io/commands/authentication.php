...
class wpl_io_cmd_authentication extends wpl_io_cmd_base
{
    ...
    private function forget_password()
    {
        ...
        {
            $message =wpl_esc::return_t('We received a password be reset request for the following account:')."\r\n";
            $message .= network_home_url('/')."\r\n";
            $message .= sprintf(wpl_esc::return_t('Username: %s'), $user_login)."\r\n";
            $message .=wpl_esc::return_t('If you did not request this change, please ignore this email.')."\r\n";
            $message .=wpl_esc::return_t('To reset your password, please follow the link below:')."\r\n";
            ...
            $title = sprintf(wpl_esc::return_t('[%s] Password Reset'), $blogname);
