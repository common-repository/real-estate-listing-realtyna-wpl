...
<div class="wpl_listing_links_container" id="wpl_listing_links_container<?php wpl_esc::attr($property_id); ?>">
	<ul>
		...
		<?php if ($show_pinterest): ?>
			<li class="pinterest_link">
				<a class="wpl-tooltip-top"
				   href="http://pinterest.com/pin/create/link/?url=<?php wpl_esc::attr($property_link); ?>&media=<?php wpl_esc::url(wpl_property::get_property_image($property_id, '300*300')); ?>&description=<?php wpl_esc::attr($wpl_properties['current']['property_title'] ?? ''); ?>"
				   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=600'); return false;"
				   title="<?php wpl_esc::attr_t('Pin it'); ?>"
				   aria-label="<?php wpl_esc::attr_t('Pin it'); ?>"></a>
		...
		<?php if ($show_pdf): ?>
			<li class="pdf_link">
				<a class="wpl-tooltip-top" href="<?php wpl_esc::url(wpl_property::get_property_pdf_link($property_id)); ?>"
				   target="_blank" title="<?php wpl_esc::attr_t('PDF'); ?>"
				   aria-label="<?php wpl_esc::attr_t('PDF'); ?>"></a>
		...
		<?php if ($show_favorite): $find_favorite_item = in_array($property_id, wpl_addon_pro::favorite_get_pids()); ?>
			<li class="favorite_link<?php wpl_esc::e($find_favorite_item ? ' added' : '') ?>">
				<a class="wpl-tooltip-top" href="#" style="<?php wpl_esc::e($find_favorite_item ? 'display: none;' : '') ?>"
				...
				<a class="wpl-tooltip-top" href="#" style="<?php wpl_esc::attr(!$find_favorite_item ? 'display: none;' : '') ?>"
		...
		<?php if ($show_crm): _wpl_import('libraries.addon_crm');
			...
			<li class="crm_link">
				<a class="wpl-tooltip-top" href="<?php wpl_esc::url($crm->URL('form')); ?>&pid=<?php wpl_esc::attr($property_id); ?>"
				   target="_blank"
		...
		<?php if ($adding_price_request and $wpl_properties['current']['raw']['price'] == 0): ?>
			<li class="adding_price_request_link">
				<a class="wpl-tooltip-top" data-realtyna-lightbox
				   data-realtyna-lightbox-opts="title:<?php wpl_esc::attr_t('Request the Price'); ?>"
				   href="<?php wpl_esc::attr($this->lightbox_container); ?>"
				   onclick="return wpl_adding_price_request(<?php wpl_esc::attr($property_id); ?>);"
				   title="<?php wpl_esc::attr_t('Request the Price'); ?>"
				   aria-label="<?php wpl_esc::attr_t('Request the Price'); ?>"></a>
				<div class="wpl-util-hidden"><?php wpl_esc::html_t('Request the Price'); ?></div>
			</li>
		<?php endif; ?>
	</ul>
	...
	<a id="wpl_favorites_lightbox" class="wpl-util-hidden" data-realtyna-href="#wpl_pshow_lightbox_content_container"
	   data-realtyna-lightbox-opts="title:<?php wpl_esc::html_t('Login to continue'); ?>"></a>
</div>