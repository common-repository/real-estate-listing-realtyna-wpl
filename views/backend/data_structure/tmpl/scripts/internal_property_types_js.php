...
jQuery(document).ready(function()
{
    wplj(".sortable_ptcategory").sortable(
    {
        ...
        update: function(e, ui)
        {
            ...
            request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=sort_property_types&sort_ids=' + stringDiv + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_remove_property_type(property_type_id, confirmed)
{
	if (!property_type_id)
	{
		wpl_show_messages("<?php wpl_esc::js_t('Invalid Property Types'); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}

	/** load delete light box **/
    wpl_remove_message('.wpl_data_structure_list .wpl_show_message');
    request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=generate_delete_page&property_type_id='+property_type_id+'&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_set_enabled_property_type(property_type_id, enabeled_status)
{
	if (!property_type_id)
	{
		wpl_show_messages("<?php wpl_esc::js_t('Invalid Property Type'); ?>", '.wpl_data_structure_list .wpl_show_message');
		return false;
	}
	...
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=set_enabled_property_type&property_type_id=' + property_type_id + '&enabeled_status=' + enabeled_status + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
{
	wpl_remove_message('.wpl_data_structure_list .wpl_show_message');
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=generate_new_page&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_generate_edit_page_property_type(property_type_id)
{
	...
	wpl_remove_message('.wpl_data_structure_list .wpl_show_message');
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=generate_edit_page&property_type_id=' + property_type_id + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_ajax_save_property_type(key, element, id)
{
    ...
    /** run ajax query **/
    request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=save_property_type&property_type_id=' + id + '&key=' + key + '&value=' + encodeURIComponent(element.value) + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
...
function wpl_ajax_insert_property_type(id)
{
    ...
    /** run ajax query **/
    request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=insert_property_type&parent=' + parent + '&name=' + name + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
...
{
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=purge_related_property&property_type_id=' + property_type_id + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
...
function assign_properties_property_type(property_type_id)
{
	...
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=assign_related_properties&property_type_id=' + property_type_id+ '&select_id=' + select_id + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
...
{
	wpl_remove_message('.wpl_data_structure_list .wpl_show_message');
	request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=generate_new_page_ptcategory&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_generate_edit_page_ptcategory(id)
{
	...
	wpl_remove_message('.wpl_data_structure_list .wpl_show_message');
	var request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=generate_edit_page_ptcategory&ptcategory_id=' + id + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
...
function wpl_ajax_insert_ptcategory(id)
{
    ...
    /** run ajax query **/
    var request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=insert_ptcategory&name=' + name + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
...
function wpl_remove_ptcategory(id, confirmed)
{
    ...
    if(!confirmed)
	{
		...
		message += '<span class="wpl_actions" onclick="wpl_remove_ptcategory(\''+id+'\', 1);"><?php wpl_esc::js_t('Yes'); ?></span>&nbsp;<span class="wpl_actions" onclick="wpl_remove_message();"><?php wpl_esc::js_t('No'); ?></span>';
    ...
    /** run ajax query **/
    var request_str = 'wpl_format=b:data_structure:ajax_property_types&wpl_function=remove_ptcategory&id=' + id + '&_wpnonce=<?php wpl_esc::attr($nonce); ?>';
	wplj.ajax({
		type: 'POST',
		dataType: 'JSON',
		url: '<?php wpl_esc::current_url(); ?>',
