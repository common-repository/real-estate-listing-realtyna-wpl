...
class wpl_listings_controller extends wpl_controller
{
    ...
    public function manager($instance = array())
    {
		...
		{
			/** import message tpl **/
			$this->message = "You don't have access to this menu! Maybe your user is not added to WPL as an agent. You can contact to website admin for this.";
    ...
    private function init_page()
    {
        ...
        {
            /** import message tpl **/
			$this->message = "You don't have access to complexes/condos. You can request access from website admin.";
			parent::render($this->tpl_path, 'message');
        ...
        {
            /** import message tpl **/
			$this->message = "You don't have access to neighborhoods. You can request access from website admin.";
			parent::render($this->tpl_path, 'message');
		...
		{
			/** import message tpl **/
			$this->message = "Sorry, you currently don't have access to this page!";
			parent::render($this->tpl_path, 'message');
    ...
    public function get_users()
    {
        ...
        if(wpl_users::is_part_of_brokerage($current_user_id))
        {
            ...
            return wpl_users::get_wpl_users(wpl_db::prepare('AND (wpl.`parent` = %d OR wpl.`id` = %d)', $broker->id, $broker->id));
        }
