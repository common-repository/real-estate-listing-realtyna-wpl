...
function wpl_listing_set_js_triggers()
{
    wplj('#list_view').on('click', function()
    {
        ...
        wplj('.wpl_profile_container').animate({opacity:0},function()
        {
            ...
            wplj('.wpl_profile_listing_profiles_container').removeClass('wpl-large-up-<?php wpl_esc::js($this->profile_columns); ?>').removeClass('wpl-medium-up-2').removeClass('wpl-small-up-1');
    ...
    wplj('#grid_view').on('click', function()
    {
        ...
        wplj('.wpl_profile_container').animate({opacity:0},function()
        {
            ...
            wplj('.wpl_profile_listing_profiles_container').addClass('wpl-large-up-<?php wpl_esc::js($this->profile_columns); ?>').addClass('wpl-medium-up-2').addClass('wpl-small-up-1');
            wplj(this).stop().animate({opacity:1});
        });
