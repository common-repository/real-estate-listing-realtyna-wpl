...
?>
<div class="wpl_property_listing_container <?php if(isset($this->property_css_class) and $this->property_css_class == 'map_box') wpl_esc::e('wpl-property-listing-mapview'); if(!$this->listing_picture_mouseover) wpl_esc::e(" wpl-prp-disable-image-hover"); ?>" id="wpl_property_listing_container">
    ...
    <a id="wpl_favorites_lightbox" class="wpl-util-hidden" data-realtyna-href="#wpl_plisting_lightbox_content_container" data-realtyna-lightbox-opts="title:<?php wpl_esc::attr_t('Login to continue'); ?>"></a>
...
<div class="wpl-powered-by-realtyna">
    <a href="https://realtyna.com/wpl-platform/ref/<?php wpl_esc::attr($this->affiliate_id); ?>/">
        <img src="<?php wpl_esc::url(wpl_global::get_wpl_url().'assets/img/idx/powered-by-realtyna.png'); ?>" alt="Realtyna" title="Powered By Realtyna" width="120" />
    </a>
</div>
<?php endif; ?>
